...
The program generates a figure containing:
...
This shows the localized oscillatory structure produced by interference between many stationary states.
...
represents the spatial probability distribution of finding the particle.

### 3. Gaussian Coefficient Distribution

The coefficients \(c_n\) show which stationary states contribute most strongly to the wave packet.
...
The displayed parameter values are generated dynamically from the Python variables.
